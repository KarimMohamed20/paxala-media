                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            dragElastic={{ left: 0.5, right: 0 }} // Allow dragging left to close
                            onDragEnd={onDragEnd}
                            className="fixed z-50 top-0 left-0 bottom-0 w-80 max-w-[80vw] bg-neutral-950 md:hidden overflow-hidden"
                            style={{ x: 0 }} // Ensure it starts at 0 when animated in
                        >
                            <AdminSidebar
                                className="w-full h-full border-r-0 pt-24" // removed border-r for mobile, added more top padding
